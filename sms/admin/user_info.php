...
th, td {
    ...
    padding: 15px;
    text-align: center;
    width: auto; /* You can set a specific width or use 'auto' for dynamic width */
}
    ...
    <div class="container">
        <aside>
            <div class="navbar">
                ...
                <a href="user_info.php" class="active">
        ...
        echo "<div class='quiz-score'>";
            ...
            echo "<table>";
                ...
                echo "<tbody>";
                    ...
                    $year = $_POST['year'];
                    $studentInfoResult = $con->query("select * from login1 where year=('$year')");
